...
function multiplyArray(multArr) {
  //eslint-disable-line
  let mulArray= multiply(multiply(multArr[0],multArr[1])[0] , multArr[2])[0];
 
  return[mulArray,`The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${mulArray}.`];
}
